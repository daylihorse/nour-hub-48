...
import { Plus, AlertTriangle, Calendar, Search, Check, X } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Monitor and manage medical alerts and reminders</p>
        </div>
        <Button>
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground mb-4">
                {searchTerm ? "No alerts match your search." : "No active medical alerts at this time."}
              </p>
              <Button>
                <Plus className="h-4 w-4 mr-2" />
                Create Alert
