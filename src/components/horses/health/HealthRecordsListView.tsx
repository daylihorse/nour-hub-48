...
interface HealthRecordsListViewProps {
...
const HealthRecordsListView = ({ records }: HealthRecordsListViewProps) => {
  return (
        ...
        <Card key={record.id}>
          <CardContent className="p-4">
            <div className="flex items-start justify-between mb-3">
              <div>
                <h3 className="font-medium text-base mb-2">{record.description}</h3>
...
export default HealthRecordsListView;
